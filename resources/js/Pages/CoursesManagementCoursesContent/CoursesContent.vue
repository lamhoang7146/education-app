    ...
    <div class="grid gap-y-4">
        <Container v-for="item in courses_contents">
            ...
            <div v-for="content_item in item?.content_items"
                 class="my-4 flex items-center justify-between p-3 rounded-lg shadow-sm border border-gray-200">
                <div class="flex items-center gap-x-4">
                    <i v-if="content_item?.content_type.includes('quiz')" class="fa-solid fa-book"></i>

    ...
    <div
        ...
        <ul class="overflow-y-auto sidebar pr-2">
            ...
            <SidebarSubmenuLink icon="fa-bars-progress" name="Courses management" reference="CoursesManagement" :component="component">
                ...
                <Link
                    :href="route('courses.management.quiz')"
                    @click="emit('emitSidebar')"
                    :class="{'dark-selected hover:dark-selected dark:hover:dark-selected':component === 'CoursesManagementQuiz/Quiz'}"
                    class="flex items-center hover:hover-selected dark:hover:dark-hover-selected py-2 mb-2 pl-4 pr-2 rounded-md transition">
                    <span class="-translate-y-[2px]"><i class="fa-solid fa-list-ul text-xs mr-2"></i></span>Quiz
                </Link>
            </SidebarSubmenuLink>
